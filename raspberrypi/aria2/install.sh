...
sudo killall aria2c
sudo wget -O /etc/aria2-webui/aria2.conf https://raw.githubusercontent.com/jjye93/config-file/refs/heads/main/raspberrypi/aria2/aria2.conf
sudo chmod 755 /etc/aria2-webui/aria2.conf
